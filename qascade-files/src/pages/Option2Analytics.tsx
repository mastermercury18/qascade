...
export default function Option2Analytics() {
      ...
      {tab === 'results' && (
        <div className="w-full max-w-3xl bg-black/40 rounded-lg p-6 border border-green-500/20 shadow-lg text-center">
          ...
          <ul className="text-gray-400 text-sm list-disc pl-6 inline-block text-left">
            <li>Quantum walk sampling reveals dominant Fock states: <span className="font-mono text-cyan-300">100001</span> and <span className="font-mono text-cyan-300">000000</span></li>
            <li>Bifurcation in path selection: progression to Casp8 or inhibition</li>
