...
export default function Option3Analytics() {
      ...
      {tab === 'results' && (
        <div className="w-full max-w-3xl bg-black/40 rounded-lg p-6 border border-green-500/20 shadow-lg text-center">
          ...
          <ul className="text-gray-400 text-sm list-disc pl-6 inline-block text-left">
            <li>Quantum walk sampling reveals dominant Fock state: <span className="font-mono text-cyan-300">0011000</span></li>
            <li>Early bifurcation at EGFR channels toward FADD, favoring apoptosis</li>
